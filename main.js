...
const lowerLimitEven = 2;
const upperLimitEven = 10;
const lowerLimitOdd = 1;
const upperLimitOdd = 9;
...
estoy tratando de hacerlo en otra rama para despues fuccionarlo
